const e=`# Understanding Market Cap: What Market Capitalization Really Means
...
For example, if a company has 1 billion shares outstanding and each share trades at $50:

**Market Cap = $50 × 1,000,000,000 = $50 billion**
...
|----------|------------------|----------------|
| **Mega-Cap** | $200B+ | Largest companies (Apple, Microsoft, Amazon); very stable, slower growth |
| **Large-Cap** | $10B - $200B | Established companies; moderate growth, lower volatility |
| **Mid-Cap** | $2B - $10B | Growing companies; balance of growth and stability |
| **Small-Cap** | $300M - $2B | Younger companies; higher growth potential, more volatile |
| **Micro-Cap** | $50M - $300M | Very small companies; highest risk and potential reward |
| **Nano-Cap** | Below $50M | Extremely small; very risky, often illiquid |
...
- Debt: $0
- Cash: $5 billion
- Enterprise value: $10B + $0 - $5B = $5 billion

Both have the same market cap, but Company B is actually "cheaper" when you account for its cash and lack of debt. Enterprise value matters when comparing companies with different capital structures.
...
**"Higher Market Cap Means Better Company"**

Not necessarily. Market cap reflects current valuation, not quality. A $100 billion company might be overvalued, while a $5 billion company might be undervalued.

**"Small-Caps Always Outperform Long-Term"**

While small-caps have historically delivered strong returns, they also experience longer periods of underperformance and higher volatility. It's not a guaranteed win.
...
**"You Can't Lose Money in Large-Caps"**

Large-cap stocks can and do decline significantly. General Electric, once a mega-cap, fell from over $60 to under $7. Size doesn't guarantee safety.
