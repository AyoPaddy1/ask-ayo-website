...
export const earningsReports: EarningsReport[] = [
  ...
  },
  {
    ...
    quarter: 'Q1',
    fiscalYear: 'FY2026',
    title: 'Starbucks Q1 FY2026: The Turnaround Is Real',
    description: 'Starbucks posted something it hasn\'t done in two years: positive comparable transaction growth in the US. Transactions were up 3% year-over-year, marking the first time since Q1 FY2024 that more people actually walked into Starbucks stores.',
    date: 'January 28, 2026',
    readTime: '9 min read',
    sector: 'Consumer',
